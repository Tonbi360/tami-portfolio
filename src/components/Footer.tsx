...
const socials = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/tamin.oi',
    icon: (
  ...
  {
    label: 'Pinterest',
    href: 'https://pin.it/4f2djDTIa',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="social-icon">
        <path d="M12 2C6.48 2 2 6.48 2 12c0 4.1 2.5 7.64 6.05 9.13-.08-.78-.15-1.98.03-2.84.17-.75 1.1-4.78 1.1-4.78s-.28-.57-.28-1.4c0-1.31.76-2.29 1.71-2.29.81 0 1.2.61 1.2 1.34 0 .82-.52 2.05-.79 3.19-.23.96.49 1.74 1.45 1.74 1.74 0 3.08-1.83 3.08-4.47 0-2.33-1.67-3.95-4.05-3.95-2.76 0-4.39 2.08-4.39 4.24 0 .84.32 1.76.72 2.25.08.1.09.18.07.28-.08.31-.27.96-.31 1.09-.05.17-.16.21-.38.13-1.41-.66-2.29-2.7-2.29-4.34 0-3.53 2.57-6.78 7.41-6.78 3.9 0 6.93 2.78 6.93 6.5 0 3.88-2.45 6.99-5.86 6.99-1.14 0-2.21-.59-2.57-1.29l-.7 2.66c-.25.98-.92 1.96-1.37 2.62 1.03.32 2.12.5 3.26.5 5.52 0 10-4.48 10-10S17.52 2 12 2z" />
      </svg>
    ),
  },
  {
    label: 'X',
    href: 'https://x.com/tamin.oi',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="social-icon">
